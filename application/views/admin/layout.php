...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?= site_url('docs') ?>" class="nav-item" target="_blank">
    ...
    <?= $extra_js ?? '' ?>
    <script>
    // Auto-register this device as admin and purge its play stats
    (function() {
        var did = localStorage.getItem('deviceId');
        if (!did) return;
        var key = 'adminDeviceRegistered_' + did;
        if (sessionStorage.getItem(key)) return;
        sessionStorage.setItem(key, '1');
        fetch('<?= site_url("admin/register_admin_device") ?>', {
            method: 'POST',
