...
$extra_css = '
    ...
    .debug-link { color: #fff; background: #667eea; text-decoration: none; font-size: 11px; padding: 3px 10px; border-radius: 12px; font-weight: 500; letter-spacing: 0.3px; transition: background 0.2s; }
    .debug-link:hover { background: #5a6fd6; }
